...
LONGCLAW_DEFAULT_CURRENCY = "USD"

LONGCLAW_OVERRIDE_SUMMARY_ITEMS =  getattr(settings, 'LONGCLAW_OVERRIDE_SUMMARY_ITEMS', False)
LONGCLAW_INCLUDE_SUMMARY_ITEMS =  getattr(settings, 'LONGCLAW_INCLUDE_SUMMARY_ITEMS', False)
